...
**منشن @** بإكمال تلقائي في كل مكان · **تسجيل صوتي** 🎙️ في البوست والتعليقات بمشغّل مخصص · إشعارات لحظية لـ ٨ أنواع تفاعل بتوست وصوت · بحث شامل (ناس / بوستات / هاشتاجات) · محفوظات خاصة · لايكات على التعليقات · ردود متداخلة · **وضع ليلي بسماء نجوم** · **أصوات ريترو مولّدة بـ Web Audio** · PWA قابلة للتثبيت · تسجيل بدون تأكيد إيميل
